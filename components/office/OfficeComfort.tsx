  ...
  return (
    <section className="bg-[#07565a] px-5 py-10 text-white sm:px-8 lg:py-16">
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-[22px] bg-[#0b676b] sm:rounded-[30px] lg:grid-cols-2 lg:items-center">
        <div className="relative aspect-[4/3] min-h-[260px] sm:aspect-[16/9] lg:aspect-auto lg:min-h-[520px]"><Image src="/office/kochi-05.webp" alt="Child-friendly area at Elite Dental Studio" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" /></div>
        <div className="p-6 sm:p-10 lg:p-12 xl:p-16">
          <p className="text-sm font-bold uppercase tracking-[.16em] text-[#4cdfd1] sm:text-base">For every generation</p>
