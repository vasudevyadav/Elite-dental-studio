...
export const officeImages: OfficeImage[] = [
  ...
  {
    src: "/office/5bbea59a-c621-473f-8a9d-c4ff63269196.webp",
    location: "Kannur",
    label: "Modern treatment room",
  },
  {
    src: "/office/609f5926-bd3d-416d-86d6-47f165877893.webp",
    location: "Kannur",
    label: "Child-friendly waiting area",
  },
  {
    src: "/office/a7fa275e-4a61-46d4-811f-bdd660d0214f.webp",
    location: "Kannur",
    label: "Advanced dental operatory",
  },
  {
    src: "/office/1f0186e7-99d0-44d4-a6dd-efb98b394a8e.webp",
    location: "Coimbatore",
    label: "Contemporary patient lounge",
  },
  {
    src: "/office/d00b4f41-5e9f-4038-b395-bf7ac3c2dafd.webp",
    location: "Coimbatore",
    label: "Technology-led treatment suite",
  },
  {
    src: "/office/439667b9-ee1f-459f-a1a5-f9f277027a4b.webp",
    location: "Coimbatore",
    label: "Reception and welcome area",
  },
];
...
export const officeFeatures = [
  [
    "01",
    "Specialist-led care",
    "Every dental concern is directed to an MDS-qualified specialist in the relevant field.",
  ],
  [
    "02",
    "Advanced diagnostics",
    "Digital X-rays and modern imaging help our team explain and plan treatment clearly.",
  ],
  [
    "03",
    "Hygiene-first spaces",
    "Thoughtfully organised clinical zones support safe, clean and efficient patient care.",
  ],
  [
    "04",
    "Comfort for every age",
    "Relaxed waiting areas and child-friendly spaces make visits easier for the whole family.",
  ],
] as const;
