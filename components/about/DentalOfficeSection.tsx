    ...
    <section className="bg-[#2c7477] px-5 pb-14 pt-10 text-[#344f51] sm:px-8 lg:pb-20 lg:pt-24">
      <div className="mx-auto max-w-7xl">
        <div className="relative rounded-[18px] bg-[#f5fbfa] p-6 shadow-[0_8px_22px_rgba(9,57,60,.3)] sm:p-9 lg:min-h-[365px] lg:p-12 lg:pr-[36%]">
          ...
          <Image src="/about/about-ab.png" alt="Elite Dental Studio interior" width={546} height={661} className="mt-7 w-full rounded-[15px] shadow-[0_10px_24px_rgba(15,58,61,.25)] lg:absolute lg:-right-1 lg:-top-14 lg:mt-0 lg:w-[32%]" />
        </div>
        <div className="mt-10 grid items-center gap-8 px-2 lg:grid-cols-[.38fr_.62fr] lg:px-7">
          ...
          <ul className="space-y-3 text-xs font-semibold italic text-white sm:text-sm">{promises.map((promise) => <li key={promise}>• {promise}</li>)}</ul>
        </div>
      </div>
    </section>
  );
