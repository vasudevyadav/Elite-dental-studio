  ...
  return (
    <section className="relative overflow-hidden bg-[#f1faf7]">
      ...
      <div className="relative mx-auto grid min-h-[490px] max-w-7xl items-center gap-10 px-5 py-14 sm:px-8 lg:grid-cols-2 lg:px-0">
        <div>
          <h2 className="text-2xl font-black uppercase text-[#29666b] sm:text-3xl">Our Mission</h2>
          <p className="mt-6 max-w-xl text-sm lg:text-base leading-6 text-[#4f6263]">We know there is more to good dental care than just the doctor. The support team and the facility make important contributions to each patient&apos;s sense of comfort and well-being. We place enormous value on the entire experience – from the first contact through your new smile and beyond.</p>
          <p className="mt-5 max-w-xl text-sm lg:text-base leading-6 text-[#4f6263]">The information found within these pages about Single Dental highlights some of our successes. We hope you find the information helpful. These pages are not a substitute for our personal response to your specific questions and concerns.</p>
        </div>
