    ...
    <section className="px-5 py-16 sm:px-8 lg:py-28">
      <div className="mx-auto grid max-w-[1120px] items-center gap-10 lg:grid-cols-[.48fr_.52fr]">
        ...
        <div>
          ...
          <Image src="/about/payment.png" alt="Accepted payment methods" width={950} height={450} className="mt-7 w-full !h-[450px] rounded-[18px] bg-[#e8f8f6] p-3 shadow-[0_8px_20px_rgba(25,90,93,.12)]" />
        </div>
      </div>
    </section>
  );
