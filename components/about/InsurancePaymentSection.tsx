      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[.48fr_.52fr]">
        ...
        <div>
          ...
          <div className="relative mt-7 overflow-hidden rounded-[18px] bg-[#e8f8f6] p-3 shadow-[0_8px_20px_rgba(25,90,93,.12)]">
            <Image src="/about/payment.png" alt="Accepted payment methods including cards, UPI, wallets and financing" width={950} height={345} className="h-auto w-full" />
            <div className="absolute inset-3 grid grid-cols-5 grid-rows-3 gap-[1.5%]" aria-label="Payment provider links">
