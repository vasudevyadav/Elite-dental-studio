    ...
    <section className="mt-10 grid items-center gap-10 lg:mt-24 lg:grid-cols-2 lg:gap-20">
      <div>
        <h2 className="text-2xl leading-tight font-bold text-[#2b7175] lg:text-[40px]">
          Aftercare Following Your
          <br />
          Laser Procedure
        </h2>
        <div className="my-5 h-px bg-gray-500" />
        <p className="my-2 text-sm leading-7 font-semibold lg:text-lg lg:leading-8">
          The aftercare period after this treatment is straightforward. Your dentist at Elite Dental
          Studio gives you specific instructions based on your procedure. General guidance includes:
        </p>
      ...
      <div className="relative min-h-[360px] overflow-hidden rounded-2xl sm:min-h-[500px] lg:min-h-[650px]">
        <Image
          src="/service/services-inner-5.png"
