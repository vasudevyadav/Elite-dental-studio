  ...
  return (
    <section className="mt-10 grid items-center gap-10 lg:mt-24 lg:grid-cols-2 lg:gap-20">
      <div className="relative min-h-[300px] overflow-hidden rounded-2xl lg:min-h-[400px]">
        <Image
          src="/service/services-inner-4.png"
      ...
      <div>
        ...
        <div className="space-y-5 text-sm leading-7 font-medium text-gray-500 lg:text-base lg:leading-8">
          <p>
            Most laser procedures at Elite Dental Studio are completed in a single sitting of 20 to
            60 minutes. Local anaesthesia or numbing gel is used where needed so you are comfortable
            throughout the procedure.
          </p>
          <p>
            After your session, mild soreness in the treated area is normal and typically settles
            within a few days. Most patients return to their regular routine the same day or the
            following day depending on the procedure.
          </p>
        </div>
      </div>
    </section>
