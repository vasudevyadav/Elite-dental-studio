...
/*echo '<pre>'; print_r($_SESSION["captcha_code_1"]); echo '</pre>';
...
// if ($error['name_h'] == '' && $error['tel_h'] == '' && $error['captcha_h'] == '') {
	...
	if ($name != '' and $phone != '') {
		...
		$mail->Subject = "Elite Dental Studio Generic Appointment";
		$mail->AltBody = "To view the message, please use an HTML compatible email viewer!"; // optional, comment out and test
		$mail->MsgHTML($body);
		$mail->AddAddress('info@elitedentalstudio.co.in', "Admin");

		$mail->addCC('elitedentalstudio.calicut@gmail.com', 'elitedentalstudio');

		$mail->addCC('poonam@reinventdigital.com', 'poonam');
		$mail->addBCC('abhisheksharma@reinventdigital.com', 'abhishek');
		$mail->Timeout = 5; // seconds
		$mail->Send();*/
		
		$to = "info@elitedentalstudio.co.in, elitedentalstudio.calicut@gmail.com, poonam@reinventdigital.com, mukesh@reinventdigital.com, sneha@reinventdigital.com, sookoon@reinventdigital.com, deepakverma@reinventdigital.com, abhisheksharma@reinventdigital.com";
        $subject = "Elite Dental Studio Implant Appointment";
		...
		echo json_encode([
		    "status" => "success",
		    "redirect" => "https://elitedentalstudio.co.in/implant/thank-you.html"
		]);
		exit;
