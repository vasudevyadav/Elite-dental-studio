...
$captchaSessionKey = $isCallBackForm
    ? 'captcha_code_2'
    : 'captcha_code_1';
...
// if ($error['name_h'] == '' && $error['tel_h'] == '' && $error['captcha_h'] == '') {
	...
	if ($name != '' and $phone != '') {
        ...
        $subject = "Elite Dental Studio Aligner Appointment";
		...
		echo json_encode([
		    "status" => "success",
		    "redirect" => "https://elitedentalstudio.co.in/coimbatore-aligner/thank-you.html"
		]);
		exit;
