...
<head>
    ...
    <title>Clear Aligners in Calicut, Kochi, Kannur | Affordable Teeth Straightening Solutions</title>

    <meta name="description"
        content="Transform your smile with Clear Aligners in Calicut, Kochi and Kannur. Customized treatment for straighter teeth. Schedule your visit today" />
...
<body>
        ...
        <div class="container">
            ...
            <div class="header-inner">
                ...
                <div class="top-lft-logo">
                    ...
                    <a href="#"><img src="images/Elite Dental Studio Logo_w.png"></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="banner-lft-cnt">
                        ...
                        <h1>Straighten your smile,<br /> boost your confidence!</h1>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-lft-img text-center">
                            ...
                            <img src="images/about_aligners.jpg" alt="About" width="400" height="596" class="img-fluid">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="abou-rgt-cnt">
                            ...
                            <div class="heading">
                                ...
                                <h2>About Clear<br /> Dental Aligners</h2>

                                <p class="mb-2">Clear Dental Aligners signify an advanced approach to orthodontic care,
                                    revolutionising the way we achieve beautifully aligned teeth. These personalised,
                                    nearly invisible trays delicately and comfortably guide your teeth into their
                                    perfect positions. Unlike conventional braces, these invisible aligners offer a
                                    sleek, metal-free alternative that preserves your natural smile throughout the
                                    treatment process.</p>

                                <p>Elite Dental Studio is a best dental clinic in Kozhikode that specialises in
                                    providing cutting-edge clear dental aligners in Kochi tailored precisely to your
                                    unique requirements, all at an affordable aligners cost. Our team of skilled
                                    orthodontics professionals dedicated to clear aligners will work closely with you to
                                    create a customised plan, ensuring a smooth and effective journey towards achieving
                                    a straighter, healthier, and more confident smile.</p>
    ...
    <section class="conter-area py-5">

        <div class="container">

            <div class="heading text-center">

                <h2>Why Trust Elite Dental Studio for Clear Dental Aligners?</h2>

                <hr style="margin: 18px auto 20px;">

            </div>

            <div class="row banner_uspes text-center">

                <div class="col-3">

                    <div class="usp_box">

                        <img src="images/dentist.png" alt="dentist" width="108" height="108" class="img-fluid">

                        <p>Committed to<br /> Excellence</p>
                ...
                <div class="col-3">
                    ...
                    <div class="usp_box">
                        ...
                        <img src="images/straightens-teeth.png" alt="straightens-teeth" width="108" height="108"
                            class="img-fluid">
                ...
                <div class="col-3">
                    ...
                    <div class="usp_box">
                        ...
                        <img src="images/technology_icon.png" alt="technology_icon" width="108" height="108"
                            class="img-fluid">

                        <p>Experienced Dental<br /> Specialists</p>
                ...
                <div class="col-3">
                    ...
                    <div class="usp_box">
                        ...
                        <img src="images/patient_icon.png" alt="patient_icon" width="108" height="108"
                            class="img-fluid">

                        <p>Individualised<br /> Treatment Plans</p>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="braces-vs-img">

                        <img src="images/vs-img.webp" alt="vs-img" class="img-fluid" width="451" height="321">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="braces-vs-cnt">

                        <div class="braces-head">

                            <div class="row align-items-center">

                                <div class="col-lg-5">

                                    <h3>Conventional Braces</h3>
                                ...
                                <div class="col-lg-5">
                                    ...
                                    <h3>Elite Dental Studio Aligners</h3>
                        ...
                        <div class="braces-ul">
                            ...
                            <ul>
                                ...
                                <li>Consists of permanent metal or ceramic brackets attached to teeth.</li>

                                <li>Use wires and rubber bands to exert constant pressure for teeth alignment.</li>

                                <li>They can be visible and are sometimes considered less aesthetically appealing.</li>

                                <li>Require regular adjustments by an orthodontist.</li>

                                <li>Often preferred for complex dental realignment needs.</li>
                            ...
                            <ul>
                                ...
                                <li>Comprise removable, transparent plastic trays customised for each patient.</li>

                                <li>Gradually reposition teeth by changing trays every few weeks.</li>

                                <li>They are nearly invisible and less noticeable.</li>

                                <li>Require fewer in-office visits.</li>

                                <li>Proven excellent for addressing mild to moderate alignment issues.</li>
    ...
    <style>
        ...
        .treatble_cases_row .owl-nav button.owl-next,

        .treatble_cases_row .owl-nav button.owl-prev {
            ...
            <div class="owl-carousel docs-owl">
                ...
                <div class="doc-item">
                    ...
                    <div class="dental-team-bx">
                        ...
                        <img src="images/Dr_Vidhu.jpg" class="img-fluid" alt="team 2">

                        <h4>Dr Vidhu Sreedharan</h4>
                ...
                <div class="doc-item">
                    ...
                    <div class="dental-team-bx">
                        ...
                        <img src="images/Dr_Manu.jpg" class="img-fluid" alt="team 1">

                        <h4>Dr. Manu Mathew</h4>

                        <p>BDS, MDS<br /> ORTHODONTICS</p>
                ...
                <div class="doc-item">
                    ...
                    <div class="dental-team-bx">
                        ...
                        <img src="images/DR-BELWIN.jpg" class="img-fluid" alt="team 3">

                        <h4>DR. BELWIN BABY</h4>

                        <p>BDS, MDS<br /> (Orthodontics & Dentofacial Orthopedics)</p>
                ...
                <div class="doc-item">
                    ...
                    <div class="dental-team-bx">
                        ...
                        <img src="images/Dr-Ferin-fathima.jpg" class="img-fluid" alt="team 4">

                        <h4>DR. Ferin Fathima</h4>

                        <p>BDS, MDS<br /> (Orthodontics) INVISALIGN CERTIFIED ORTHODONTIST</p>
    ...
    <section class="how-it-works pb-0">
        ...
        <div class="work-shape d-none d-md-block">

            <img src="images/work-shape.png" alt="work-shape" class="img-fluid">
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="how-work-cnt">

                        <div class="work-bx">

                            <span>01.</span>

                            <p><b>Personalized Design:</b> An orthodontist creates a unique digital 3D model of your
                                teeth.</p>
                        ...
                        <div class="work-bx">
                            ...
                            <p><b>Tailored Aligner Production:</b> Clear plastic aligner trays are meticulously crafted
                                in a customised series.</p>
                        ...
                        <div class="work-bx">
                            ...
                            <p><b>Gradual Progress:</b> Each aligner set gently adjusts your teeth in a step-by-step
                                manner.</p>
                        ...
                        <div class="work-bx">
                            ...
                            <p><b>Regular Renewal:</b> You wear each set for about 1-2 weeks before transitioning to the
                                next one, ensuring continuous improvement.</p>
                ...
                <div class="col-lg-6 mt-4 mt-md-0">
                    ...
                    <div class="how-work-img text-center text-md-start">

                        <img src="images/How-does-it-work-min.webp" alt="How-does-it-work-min" class="img-fluid"
                ...
                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#myModalappointment"
                    ...
                    <div class="t-inner">
                        ...
                        <div class="img-box">
                            ...
                            <img src="images/talk_to_icon.png" alt="talk_to_icon">
    ...
    <section class="type-of-implants">
        ...
        <div class="container" style="max-width: 1200px">
            ...
            <div class="row treatble_cases_row">

                <div class="col-lg-4">

                    <div class="implant-bx">

                        <img src="images/aligner-1.png" alt="">

                        <h3>Mild Crowding</h3>

                        <p>Aligners gently head slightly misaligned teeth into their correct positions, effectively
                            treating mild crowding.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="implant-bx">
                        ...
                        <img src="images/aligner-2.png" alt="">

                        <h3>Spacing Concerns</h3>

                        <p>Aligners coax teeth closer together over time, successfully closing small gaps between them.
                        </p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="implant-bx">
                        ...
                        <img src="images/aligner-3.png" alt="">

                        <h3>Overbite Correction</h3>

                        <p>Invisible dental aligners effectively address minor overbites by adjusting the positioning of
                            both upper and lower teeth.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="implant-bx">
                        ...
                        <img src="images/aligner-4.png" alt="">

                        <h3>Underbite Correction</h3>

                        <p>In mild cases, invisible dental aligners enhance an underbite by subtly moving the lower
                            teeth forward.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="implant-bx">
                        ...
                        <img src="images/aligner-5.png" alt="">

                        <h3>Open Bite</h3>

                        <p>Aligners can correct an open bite, encouraging proper teeth alignment when biting down.</p>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="implant-bx">
                        ...
                        <img src="images/aligner-6.png" alt="">

                        <h3>Rotation or Tilt</h3>

                        <p>Aligners can rectify minor tooth rotations or tilting, resulting in improved alignment and
                            aesthetics.</p>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="headingOne">
                                    ...
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                        ...
                                        1. How much do Clear Dental Aligners cost at Elite Dental Studio?
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        The cost of our Clear Dental Aligners is tailored to individual needs. Schedule
                                        a consultation with our experts to get a personalised quote based on your
                                        specific dental requirements. However, the approximate dental aligners cost is
                                        about <b>INR 30,000 to 90,000.</b>
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="headingTwo">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        2. Are these aligners truly invisible?
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        Yes, our Clear Dental Aligners are virtually invisible. Made from transparent
                                        material, they provide a discreet way to straighten your teeth without the
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="headingThree">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        3. How do Clear Dental Aligners differ from other types of dental aligners?
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        Our Clear Dental Aligners available at our 'dental clinic near me,' are
                                        custom-made and designed specifically for you. They offer a comfortable and
                                        effective way to straighten your teeth, ensuring a personalised treatment plan
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="headingfour">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        4. How long does the treatment with Clear Dental Aligners typically take?
                                ...
                                <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        The duration of the treatment varies based on individual cases. During your
                                        consultation, our orthodontic experts will assess your needs and provide you
                                        with an estimated timeline for your Clear Dental Aligners treatment.
                            ...
                            <div class="accordion-item">
                                ...
                                <h2 class="accordion-header" id="headingfour">
                                    ...
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        5. Are InvisibleDental Aligners suitable for everyone, regardless of age?
                                ...
                                <div id="collapsefour" class="accordion-collapse collapse" aria-labelledby="headingfour"
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        Clear Dental Aligners are a versatile option suitable for many age groups. Our
                                        experienced orthodontists at Elite Dental Studio - a best dental clinic in
                                        Calicut will evaluate your dental condition during the consultation to determine
                                        if Clear Dental Aligners are the right choice for you, regardless of your age.
            ...
            <div class="modal-content">
                ...
                <div class="call-back-area book-appointment">
                    ...
                    <div class=" appointment-form">
                        ...
                        <form class="service-form" method="POST" id="elite_2" action="submit.php"
    ...
    <div class="support-icon">
        ...
        <a href="https://api.whatsapp.com/send?phone=918714608881"><img src="images/whatsapp.webp" alt="whatsapp logo"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name" name="name"
                                            id="bname_" onkeypress="return lettersOnly(event);" required <?php if (isset($_session['yname']) && $_session['yname'] != "") { ?>value="<?php echo $_SESSION['yname'] ?>" <?php }
                                            $_SESSION['yname'] = "" ?>>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <?php /* ?> <input type="text" class="form-control" placeholder="Phone"
                                       name="phone" id="bphone_" onkeypress="return validateNumber(event);"
                                       maxlength="10" minlength="10" required
                                       <?php if(isset($_session['ytel']) && $_session['ytel'] != ""){?>value="<?php echo $_SESSION['ytel']?>"
                                       <?php } $_SESSION['ytel'] = ""?>>
                                   ...
                                   <?php */ ?>
                                        ...
                                        <input type="text" class="form-control" placeholder="Phone" name="phone"
                                            id="bphone_" onKeyPress="return isNumber(event);" maxlength="10"
                                            minlength="10" required <?php if (isset($_session['ytel']) && $_session['ytel'] != "") { ?>value="<?php echo $_SESSION['ytel'] ?>" <?php }
                                            $_SESSION['ytel'] = "" ?>>
                                ...
                                <div class="col-md-12">
                                   ...
                                   <input type="text" class="form-control" placeholder="Location" name="location"
                                       id="location_" onKeyPress="return onlyAlphabets(event);" required
                                       <?php if(isset($_session['yname']) && $_session['yname'] != ""){?>value="<?php echo $_SESSION['yname']?>"
                                       <?php } $_SESSION['yname'] = ""?>>
    ...
    <script>
        ...
        if (ww < 767) {
            ...
            $('.treatble_cases_row').removeClass('row').addClass('owl-carousel')

                .find('.col-lg-4').addClass('item').removeClass('col-lg-4');

            $('.treatble_cases_row').owlCarousel({
