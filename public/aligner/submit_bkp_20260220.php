...
//$mail->Host       = "webmail.vitaldentalcare.co.in"; // SMTP server
		...
		$mail->Subject = "Elite Dental Studio Aligners Appointment";
		...
		//$mail->addBCC('ashish@reinventdigital.com', 'ashish');
		$mail->Send();


		header('Location: https://elitedentalstudio.co.in/aligner/thank-you.html');
		exit;
