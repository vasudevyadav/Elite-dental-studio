...
export const homeFaqContent: FAQSectionContent = {
  ...
  description: "Find quick and expert-verified answers to your quick queries about our dental services, procedures or patient care.",
  items: [
    { question: "What can I expect during my first visit?", answer: "Your first visit includes a full mouth examination, X-rays if anything looks unclear, and a written treatment plan that lists what was found and the options available to treat it." },
    { question: "Does Elite Dental Studio offer no cost EMI?", answer: "Yes. We accept Bajaj and Zest No Cost EMI on all our treatments, making it easier to manage the cost of your dental care. Contact our reception team for more information or assistance with the EMI process." },
    { question: "How often should I visit the dentist?", answer: "Most patients need a dental checkup every six months for cleaning and early diagnosis, unless your dentist has already set a different schedule based on your gum health or past treatment." },
    { question: "Do you offer emergency dental care?", answer: "Yes, Elite Dental Studio offers emergency dental care for severe pain, swelling, a broken tooth or sudden bleeding. Call our emergency contact number and our on-duty dentist will see you as soon as possible." },
  ],
};
...
export const appointmentContent: AppointmentSectionContent = {
  ...
  description: "Ready to take the next step for your healthier smile? Book online or call us to schedule your dental appointment in Calicut, Kochi, Kannur or Coimbatore.",
